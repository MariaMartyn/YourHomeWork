...
Посвящен работе с удаленным репозиторием.

## Основные команды:

### * *"git clone"* - команда, с помощью которой мы создаем на локальном репозитории копию удаленного репозитория

### * *"git push"* - команда, осуществляющая выгрузку содержимого локального репозитория в удаленный репозиторий

### * *"git pull"* - команда, обеспечивающая извлечение и загрузку данных из удаленного репозитория и слияние этих данных с содержимым локального репозитория

### * *"git fetch"* - команда, помогающая осуществить загрузку содержимого из удаленного репозитория